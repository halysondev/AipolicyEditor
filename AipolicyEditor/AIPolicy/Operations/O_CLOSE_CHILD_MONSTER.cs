...
{
    public class O_CLOSE_CHILD_MONSTER : IOperation, ICloneable
    {
        [Browsable(false)]
        public int FromVersion => 33;
        [Browsable(false)]
        public int OperID => 59;
        [Browsable(false)]
        ...
        public object Clone()
        {
            return new O_CLOSE_CHILD_MONSTER() { iMonsterID = iMonsterID, Target = Target.Clone() as TargetParam  };
        }
    }
}

...
namespace AipolicyEditor.AIPolicy.Operations
{
	...
	public class O_89 : IOperation, ICloneable
	{
		...
		{
			if (Value1.ToString().Contains(str) || MonsterID.ToString().Contains(str) || Value3.ToString().Contains(str) || Value4.ToString().Contains(str) || Value5.ToString().Contains(str) || Value6.ToString().Contains(str) || Value7.ToString().Contains(str) || Value8.ToString().Contains(str) || Value8.ToString().Contains(str) || Value10.ToString().Contains(str))
			{
				return true;
			}
			return false;
